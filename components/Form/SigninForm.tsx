  ...
  return (
    <form className="max-w-md md:ml-auto">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <input name="remember-me" type="checkbox" className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
        ...
        <div className='block sm:hidden'>
            <p className="text-center text-sm mt-12 text-gray-800">Don't have an account <a href="/signup" className="text-blue-600 font-semibold hover:underline ml-1">Register here</a></p>
        </div>
    </form>
  )
}
